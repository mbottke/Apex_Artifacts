...
import pathlib
src='file://'+str(pathlib.Path('call_analysis/recommendations_doc.html').resolve())
out='deliverables/26-27_Call_Schedule_Optimization_Recommendations.pdf'
...
with sync_playwright() as p:
    ...
    b.close(); print('pageerrors:',errs[:4])
